...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("2bb7f301-ac3f-4182-b580-a1f5ec3ee4f5 6440919740676248387 MySecondRestX mysecondrestx".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in mysecondrestx package as a set of config entries
        return configLoader.fromResource("mysecondrestx/settings");
    }
